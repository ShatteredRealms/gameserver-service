...
//
//	mockgen -source=/home/wil/sro/gameserver-service/pkg/repository/map.go -destination=/home/wil/sro/gameserver-service/pkg/repository/mocks/map.go
//
...
func (m *MockMapRepository) GetDeletedMaps(ctx context.Context) (game.Maps, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMapRepositoryMockRecorder) GetDeletedMaps(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeletedMaps", reflect.TypeOf((*MockMapRepository)(nil).GetDeletedMaps), ctx)
}
