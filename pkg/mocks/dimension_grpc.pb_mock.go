...
// Source: /home/wil/dev/sro/gamesever-service/pkg/pb/dimension_grpc.pb.go
//
// Generated by this command:
//
//	mockgen -package=mocks -source=/home/wil/dev/sro/gamesever-service/pkg/pb/dimension_grpc.pb.go -destination=/home/wil/dev/sro/gamesever-service/pkg/mocks/dimension_grpc.pb_mock.go
//
...
// GameServerUpdate mocks base method.
func (m *MockDimensionServiceClient) GameServerUpdate(ctx context.Context, in *pb0.TargetId, opts ...grpc.CallOption) (*pb.GameServerUpdateResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GameServerUpdate", varargs...)
	ret0, _ := ret[0].(*pb.GameServerUpdateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GameServerUpdate indicates an expected call of GameServerUpdate.
func (mr *MockDimensionServiceClientMockRecorder) GameServerUpdate(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GameServerUpdate", reflect.TypeOf((*MockDimensionServiceClient)(nil).GameServerUpdate), varargs...)
}
...
// GameServerUpdate mocks base method.
func (m *MockDimensionServiceServer) GameServerUpdate(arg0 context.Context, arg1 *pb0.TargetId) (*pb.GameServerUpdateResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GameServerUpdate", arg0, arg1)
	ret0, _ := ret[0].(*pb.GameServerUpdateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GameServerUpdate indicates an expected call of GameServerUpdate.
func (mr *MockDimensionServiceServerMockRecorder) GameServerUpdate(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GameServerUpdate", reflect.TypeOf((*MockDimensionServiceServer)(nil).GameServerUpdate), arg0, arg1)
}
